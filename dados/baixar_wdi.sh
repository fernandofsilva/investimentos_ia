...
for code in NV.IND.MANF.ZS NV.IND.TOTL.ZS TX.VAL.MANF.ZS.UN TX.VAL.TECH.MF.ZS SP.POP.SCIE.RD.P6 GB.XPD.RSDV.GD.ZS NY.GDP.DEFL.ZS; do
...
ind = {"NV.IND.MANF.ZS":"manuf_pib","NV.IND.TOTL.ZS":"ind_pib","TX.VAL.MANF.ZS.UN":"manuf_exp","TX.VAL.TECH.MF.ZS":"hitech_exp_wdi",
       "SP.POP.SCIE.RD.P6":"pesq_pm","GB.XPD.RSDV.GD.ZS":"rd_pct_wdi","NY.GDP.DEFL.ZS":"deflator"}
rows = {}
